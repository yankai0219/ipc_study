...
int main()
{
    ...
    fprintf(stdout, "wait signal is trigger\n");
    sigsuspend(&set);
    
    if (yk_quit == 1) {
        printf("quit signal is trigger\n");
    } else if (yk_alam == 1) {
        printf("alam signal is trigger\n");
    } else if (yk_int == 1) {
        printf("int signal is trigger\n");
    } else if (yk_chld == 1) {
        printf("chld signal is trigger\n");
    }
